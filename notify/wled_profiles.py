...
WLED_PROFILE_DEFINITIONS = {
	'idle': {
		...
		'config': {
			...
			'transition': 10,
			'seg': [{'fx': WLED_EFFECTS['solid'], 'col': [WLED_COLORS['white']]}],
		},
	},
	'booting': {
		'id': 201,
	...
	'error_fault': {
		...
		'config': {
			...
			'bri': 255,
			'transition': 5,
			'seg': [{'fx': WLED_EFFECTS['solid'], 'col': [WLED_COLORS['red']]}],
		},
	},
	'night_mode': {
		'id': 211,
		...
		'config': {
			...
			'transition': 10,
			'seg': [{'fx': WLED_EFFECTS['solid'], 'col': [WLED_COLORS['amber']]}],
		},
	},
}
...
class WLEDProfileManager:
	...
	def push_all_profiles(self, custom_profile_numbers=None):
		...
		if not device_info:
			return {'success': False, 'message': 'Could not connect to WLED device', 'profiles_pushed': 0}
		...
		results = {'success': True, 'message': '', 'profiles_pushed': 0, 'profiles': [], 'errors': []}
	...
	def clear_all_pifire_profiles(self):
		...
		results = {'success': True, 'message': '', 'profiles_deleted': 0, 'errors': []}
