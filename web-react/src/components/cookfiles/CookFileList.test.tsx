...
import * as actualFilesApi from "../../helpers/files/filesApi" with { rstest: "importActual" };
import type { FileListing } from "../../helpers/files/fileTypes";

const fetchFileListingMock = rs.fn();
rs.mock("../../helpers/files/filesApi", () => ({
  ...actualFilesApi,
...
const { CookFileList } = await import("./CookFileList");
