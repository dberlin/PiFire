  ...
  return (
    <div data-pf="system" className="pf-dash-card pf-dash-system">
      ...
      <StatusRow
        name="AUGER"
        o={auger}
        icon={<AugerIcon color={auger.color} on={auger.on} feed={auger.on && animate} />}
      />
      <StatusRow
        name="IGNITER"
        o={igniter}
        icon={<IgniterIcon on={igniter.on} color={igniter.color} anim={igniter.on && animate} />}
      />
    </div>
  );
}
    ...
    <svg width={60} height={40} viewBox="0 0 100 60">
      ...
      <path
        ...
        style={{
          ...
          animation: anim ? "pf-flicker 1.6s ease-in-out infinite" : "none",
        }}
      />
    </svg>
  );
