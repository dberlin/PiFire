...
JSON_WEB_CONTRACT_INVENTORY: tuple[JsonWebContract, ...] = (
    ...
    _http("POST /api/wizard/cancel", RowsResult, "wizard"),
    ...
    _http("POST /api/wizard/scan/bluetooth", BtRowsResult, "wizard"),
    _http("POST /api/wizard/scan/thermoworks", ThermoworksRowsResult, "wizard"),
    _http(
    ...
    _http("POST /api/probe_map", ProbeMap, "wizard", ProbeMap),
    ...
    _http("POST /api/files/cookfiles/delete", ApiEnvelope, "content", FilenameData),
    _http("POST /api/files/cookfiles/title", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/label", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/recover", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/comments", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/comments/assets", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/assets/delete", ApiEnvelope, "content"),
    _http("POST /api/files/cookfiles/thumbnail", ApiEnvelope, "content"),
    _http("POST /api/files/recipes/assets/delete", ApiEnvelope, "content"),
    _http("POST /api/files/recipes/create", ApiEnvelope, "content"),
    _http("POST /api/files/recipes/delete", ApiEnvelope, "content", FilenameData),
    _http("POST /api/files/recipes/run", ApiEnvelope, "content", FilenameData),
