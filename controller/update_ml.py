...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c", "--create", action="store_true", required=False, help="Create a new model, with input CSV data."
    )
    parser.add_argument(
        "-u", "--update", action="store_true", required=False, help="Update existing model, with input csv data."
    )
