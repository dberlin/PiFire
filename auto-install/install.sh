...
$SUDO apt install python3-dev python3-pip python3-venv python3-scipy nginx git supervisor ttf-mscorefonts-installer gfortran libopenblas-dev liblapack-dev libopenjp2-7 libglib2.0-dev bluetooth bluez cage seatd wlr-randr -y 2>&1 | tee -a ~/logs/pifire_install.log
if [ ${PIPESTATUS[0]} -ne 0 ]; then
