...
from display._button_input import ButtonInputMixin
...
class Display(ButtonInputMixin, DisplayBase):
    ...
    def _init_display_device(self):
        ...
        self.device = ili9341(
            self.serial, active_low=False, width=320, height=240, gpio_LIGHT=led_pin, rotate=self.rotation
        )
