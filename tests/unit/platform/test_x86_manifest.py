...
def test_x86_platform_settings_dependencies():
    ...
    # Chip selector plus the composite I2C bus and address.
    ...
    assert deps["i2c_bus"]["type"] == "i2c_bus"
    assert deps["i2c_bus"]["default"] == {"kind": "basic"}
    assert deps["i2c_bus"]["settings"] == ["platform", "fan_controller", "i2c_bus"]
