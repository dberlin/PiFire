    ...
    if (request.method == "POST") and ("form" in request.content_type):
            ...
            if requestform["update"] in ["metadata"]:
                ...
                if recipe["ingredients"][ingredient_index]["name"] != requestform["name"]:
                    ...
                    for index, direction in enumerate(recipe["instructions"]):
                        if (
                            recipe["ingredients"][ingredient_index]["name"]
                            in recipe["instructions"][index]["ingredients"]
                        ):
                            recipe["instructions"][index]["ingredients"].remove(
                                recipe["ingredients"][ingredient_index]["name"]
                            )
                ...
                recipe_data["recipe"]["steps"][step_index]["notify"] = (
                    True if requestform["notify"] == "true" else False
                )
        ...
        if "recipeshowasset" in requestform:
            ...
            return render_template_string(
                render_string, assets=assets, recipe_id=recipe_id, selected_asset=selected_asset
            )
